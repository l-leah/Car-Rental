				...
				<form action="" id="manage-car">
					...
					<div class="form-group row">
						<div class="col-md-4">
							...
							<input type="text" class="form-control" name="brand"
								value="<?php echo isset($brand) ? $brand : '' ?>" required>
						</div>
						<div class="col-md-4">
							<label for="" class="control-label">Model</label>
							<input type="text" class="form-control" name="model"
								value="<?php echo isset($model) ? $model : '' ?>" required autocomplete="off">
						</div>
					</div>
					<div class="form-group row">
						<div class="col-md-4">
						...
						<div class="col-md-4">
							...
							<select class="custom-select select2" name="transmission_id">
								...
								while ($row = $qry->fetch_assoc()):
									?>
									<option value="<?php echo $row['id'] ?>" <?php echo isset($transmission_id) && $transmission_id == $row['id'] ? 'selected' : '' ?>><?php echo $row['name'] ?>
									</option>
								<?php endwhile; ?>
							</select>
						</div>
					...
					<div class="form-group row">
						<div class="col-md-10">
							...
							<textarea name="description" id="description" class="form-control jqte" cols="30" rows="5"
					...
					<div class=" row form-group">
						...
						<div class="col-md-5">
							<img src="<?php echo isset($img_path) ? 'assets/uploads/cars_img/' . $img_path : '' ?>"
								alt="" id="img_path-field">
						</div>
					</div>
					<div class="row">
						<div class="col-md-12">
