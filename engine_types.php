							...
							<div class="row">
								<div class="col-md-12">
									...
									<button class="btn btn-sm btn-default col-sm-3" type="button"
										onclick="$('#manage-engine').get(0).reset()"> Cancel</button>
								</div>
							</div>
						</div>
					</div>
						...
						<table class="table table-bordered table-hover">
							<thead>
								<tr>
									...
									<th class="text-center">Engine Type Information</th>
							...
							<tbody>
								...
								while ($row = $engine->fetch_assoc()):
									...
									<tr>
										...
										<td class="text-center">
											<button class="btn btn-sm btn-primary edit_engine" type="button"
												data-name="<?php echo $row['name'] ?>">Edit</button>
											<button class="btn btn-sm btn-danger delete_engine" type="button"
