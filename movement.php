							...
							<tbody>
								...
								while ($row = $movements->fetch_assoc()):
									...
									<tr>
										...
										<td class="">
											<p> <b>
													<?php echo date("M d,Y h:i A", strtotime($row['pickup_datetime'])) ?>
												</b></p>
										</td>
										<td class="">
											<p> <b>
													<?php echo date("M d,Y h:i A", strtotime($row['dropoff_datetime'])) ?>
												</b></p>
										</td>
										<td>
											<p>Brand: <b>
											...
											<p>Registration #: <b>
													<?php echo ($row['car_registration_no']) ?>
												</b></p>
											<p>Plate #: <b>
													<?php echo ($row['car_plate_no']) ?>
												</b></p>
										</td>
										<td>
										...
										<td class="text-center">
											<button class="btn btn-sm btn-primary edit_movement" type="button"
												data-id="<?php echo $row['id'] ?>">Edit</button>
											<button class="btn btn-sm btn-danger delete_movement" type="button"
...
<script>
	...
	$('.edit_movement').click(function () {
		uni_modal("Manage Pick-up/Drop-off Details", "manage_movement.php?id=" + $(this).attr('data-id'), "mid-large")
