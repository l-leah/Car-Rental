							...
							<div class="row">
								<div class="col-md-12">
									...
									<button class="btn btn-sm btn-default col-sm-3" type="button"
										onclick="$('#manage-transmission').get(0).reset()"> Cancel</button>
								</div>
							</div>
						</div>
					</div>
								...
								while ($row = $transmission->fetch_assoc()):
									...
									<tr>
										...
										<td class="">
											...
											<p><small>Description: <b>
														<?php echo $row['description'] ?>
													</b></small></p>
										</td>
										<td class="text-center">
											<button class="btn btn-sm btn-primary edit_transmission" type="button"
												data-id="<?php echo $row['id'] ?>"
												data-description="<?php echo $row['description'] ?>"
												data-name="<?php echo $row['name'] ?>">Edit</button>
											<button class="btn btn-sm btn-danger delete_transmission" type="button"
