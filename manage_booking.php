...
<div class="container-fluid">
	<form action="" id="manage-book">
		...
		<div class="form-group">
			<label for="" class="control-label">Pick-up Date/Time</label>
			<input type="text" class="form-control datetimepicker" required="" name="pickup_datetime"
				value="<?php echo isset($pickup_datetime) ? date("Y-m-d H:i", strtotime($pickup_datetime)) : '' ?>"
				autocomplete="off">
		</div>
		<div class="form-group">
			...
			<input type="text" class="form-control datetimepicker" required="" name="dropoff_datetime"
				value="<?php echo isset($dropoff_datetime) ? date("Y-m-d H:i", strtotime($dropoff_datetime)) : '' ?>"
				autocomplete="off">
		</div>
		<div class="form-group">
