	...
	<form action="" id="manage-movement">
		...
		<div class="" id="booked_details">
			<?php if (isset($_GET['id'])): ?>
				...
				<p>Pickup Schedule: <b>
						<?php echo $pickup_datetime ?>
					</b></p>
				<p>Drop-off Schedule: <b>
						<?php echo $dropoff_datetime ?>
					</b></p>
			<?php endif; ?>
		</div>
		<div class="row form-group">
			<div class="col-md-12">
				...
				<input type="text" class="form-control" name='car_registration_no'
					value="<?php echo isset($car_registration_no) ? $car_registration_no : '' ?>" required>
			</div>
		</div>
		<div class="row form-group">
			<div class="col-md-12">
				...
				<input type="text" class="form-control" name='car_plate_no'
					value="<?php echo isset($car_plate_no) ? $car_plate_no : '' ?>" required>
			</div>
		</div>
		<?php if (isset($_GET['id'])): ?>
			<div class="row form-group">
